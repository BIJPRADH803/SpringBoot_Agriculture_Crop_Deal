...
public class GlobalExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorInfo> handleFarmerNotExistingException(Exception e, HttpServletRequest req) {
    ...
    public ResponseEntity<ErrorInfo> handleFarmerAlreadyException(Exception e, HttpServletRequest req) {
