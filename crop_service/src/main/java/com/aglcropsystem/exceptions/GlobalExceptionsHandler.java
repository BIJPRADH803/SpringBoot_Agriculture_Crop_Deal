...
public class GlobalExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorInfo> handleCropsNotExistingException(Exception e, HttpServletRequest req) {
    ...
    @ExceptionHandler(CropsAlreadyExistException.class)
    public ResponseEntity<ErrorInfo> handleCropsAlreadyException(Exception e, HttpServletRequest req) {
